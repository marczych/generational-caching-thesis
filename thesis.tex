...
% TODO: The static cache stuff is repeated from the Terminology section but it's useful to convey that they are typically used for search engines.
...
% TODO: Update example to have a generational caching solution and explain solution in implementation.
\begin{subfigure}[b]{1.0\textwidth}
   \begin{ssp}
   \begin{minted}{sql}
   SELECT *
