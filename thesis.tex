...
The following text describes iFixit's production architecture at the time of this writing.

iFixit runs 2 load balancers - one for iFixit and one for their SaaS.
At any given time there are typically 4 to 8 application machines that run iFixit's core software which is written in PHP.
...
However, for web sites it has been broadened to include items such as recommended content.
...
The following was taken from various papers written on the subject of caching.
Some of it may not be relevant anymore and some of it could be moved to other background sections.
