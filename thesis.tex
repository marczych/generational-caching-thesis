...
This approach can also be used for caching ad hoc query results.
Figure ~\ref{fig:adHocQueryCaching} demonstrates caching an ad hoc query using {\tt cacheGetAndSet}.
The cache key is constructed using the guide's full cache key and the string {\tt -steps}.
