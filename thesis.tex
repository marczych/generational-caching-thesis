...
% TODO: You need a list of all caching scenarios you ran the tests on.
...
% TODO: Separate these so it doesn't sound like control/gc are on figure requestsPerSecXTime.
...
% TODO: Show traffic without requests for teardown.
\begin{figure}[h]
\centering
...
% TODO: Comment on cache hit rate going down - mention that it is explained in the analysis.
\begin{table}[h]
\begin{center}
\begin{tabular}{| l | l | l | l | l |}
   \hline
...
% TODO: Highlight region with increased misses (hours 20-30ish).
\begin{figure}[htp]
\centering
...
\section{Analysis}
% TODO: Include an actual number on number of additional requests during that period.
