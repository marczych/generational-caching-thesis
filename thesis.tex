...
\numberofmembers{3} \chair{Alexander Dekhtyar, Ph.D., Associate Professor, Computer Science} \othermemberA{Phillip Nico, Ph.D., Associate Professor, Computer Science} \othermemberB{Chris Lupo, Ph.D., Assistant Professor, Computer Science} \field{Computer Science} \campus{San Luis Obispo}
...
% TODO: Explain what Memcached is?
...
\begin{table}[h]
\begin{center}
\begin{tabular}{| p{.315\textwidth} | p{.29\textwidth} | p{0.295\textwidth} |}
   \hline
