...
% TODO: Put a box around code samples.
...
In particular, HTML generation time, number of database queries, and average response time decreased by X\%, Y\%, and Z\%, respectively.
