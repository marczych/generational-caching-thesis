...
Figures \ref{fig:teardownRespTimeXTime} and \ref{fig:normalRespTimeXTime} show average response time over the entirety of the experiment.

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{assets/teardownRespTimeXTime.png}
\caption{Teardown traffic response time over time}
...
\caption{Normal traffic response time over time}
